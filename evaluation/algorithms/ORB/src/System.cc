...
{
    cout << endl << "Saving pointcloud to " << filename << " ..." << endl;
    ...
    f.open(filename.c_str());
    f << fixed;
    std::vector<MapPoint*> allMapPoints = pBiggerMap -> GetAllMapPoints();
    f << "ply" << endl;
    f << "format ascii 1.0" << endl;
    f << "comment author: ply from ORB" << endl;
    f << "element vertex 610816" << endl;
