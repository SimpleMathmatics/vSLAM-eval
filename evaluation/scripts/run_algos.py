            ...
            for j in range(3):
                ...
                if platform == "linux" or platform == "linux2":
                    try:
                        ...
                        res_orb_data_dir = os.path.join(res_orb_dir, "data_" + str(j))
                        ...
                        try:
                            ...
                            shutil.move("pq.ply", os.path.join(res_orb_data_dir, "PointCloud.txt"))
                        ...
                        preproc.get_gt_pos_df().to_csv(os.path.join(res_orb_data_dir, "position_gt.csv"), index=False)
                        ...
                        if resolution == 1:
                            res_dso_data_dir = os.path.join(res_dso_dir, "data_" + str(j))
                            ...
                            print("aligning the timestamps...")
                            preproc.align_timestamps()
                            preproc.get_gt_pos_df().to_csv(os.path.join(res_dso_data_dir, "position_gt.csv"), index=False)
                            print("transforming the coordinate system...")
                       ...
                       ##################### DSM ###########################
                        if resolution == 1:
                            ...
                            res_dsm_data_dir = os.path.join(res_dsm_dir, "data_" + str(j),)
                            ...
                            print("aligning the timestamps...")
                            preproc.align_timestamps()
                            preproc.get_gt_pos_df().to_csv(os.path.join(res_dsm_data_dir, "position_gt.csv"), index=False)
                            print("transforming the coordinate system...")
