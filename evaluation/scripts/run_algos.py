        ...
        for i in range(3): 
            ...
            if platform == "linux" or platform == "linux2":
                try:
                    ...
                    res_orb_data_dir = os.path.join(res_orb_dir, "data_" + str(i))
                    ...
                    if resolution == 1:
                        res_dso_data_dir = os.path.join(res_dso_dir, "data_" + str(i))
                   ...
                   ##################### DSM ###########################
                    if resolution == 1:
                        ...
                        res_dsm_data_dir = os.path.join(res_dsm_dir, "data_" + str(i),)
